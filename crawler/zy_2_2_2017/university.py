...
class UniveristyWebPage(object):
    ...
    'applicant_num_received','toudang_detail_url','quedang_num','admission_guide_desc','admission_guide_url']
        ...
        self.batch = u'zy_2_2_2017'  # 本科提前B第一次网报
        self.create_dir()
...
if __name__ == '__main__':
    a = {
        u'普通文科': 'http://www.nm.zsks.cn/zy_2_2_2017/2_A_2.html',
        u'普通理科': 'http://www.nm.zsks.cn/zy_2_2_2017/2_B_2.html',
        u'蒙授文科': 'http://www.nm.zsks.cn/zy_2_2_2017/2_C_2.html',
        u'蒙授理科': 'http://www.nm.zsks.cn/zy_2_2_2017/2_D_2.html'
    }
    for k in a:
        print k, a[k]
