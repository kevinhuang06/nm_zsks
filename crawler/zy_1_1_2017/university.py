...
class UniveristyWebPage(object):
   ...
   'min_score','toudang_proportion','min_score_1vs1','applicant_num_needed',\
    'applicant_num_received','toudang_detail_url','quedang_num','admission_guide_desc','admission_guide_url']
        ...
        self.batch = u'zy_1_1_2017'  # 本科提前A第一次网报
        self.create_dir()
...
if __name__ == '__main__':
    a = {
        u'普通文科': 'http://www.nm.zsks.cn/zy_1_1_2017/1_A_10.html',
        u'普通理科': 'http://www.nm.zsks.cn/zy_1_1_2017/1_B_10.html',
        u'蒙授文科': 'http://www.nm.zsks.cn/zy_1_1_2017/1_C_10.html',
        u'蒙授理科': 'http://www.nm.zsks.cn/zy_1_1_2017/1_D_10.html'
    }
    for k in a:
        print k, a[k]
