...
class UniveristyWebPage(object):
    ...
    'applicant_num_received','toudang_detail_url','quedang_num','admission_guide_desc','admission_guide_url']
        ...
        self.batch = u'zy_4_3_2017'  # 本科二批第三次网报
        self.create_dir()
...
if __name__ == '__main__':
    ...
    a = {
        u'普通文科': 'http://www.nm.zsks.cn/zy_4_3_2017/4_A_1.html',
        u'普通理科': 'http://www.nm.zsks.cn/zy_4_3_2017/4_B_1.html',
        u'蒙授理科': 'http://www.nm.zsks.cn/zy_4_3_2017/4_D_1.html',
    }
    for k in a:
        print k, a[k]
