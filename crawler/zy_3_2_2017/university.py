...
class UniveristyWebPage(object):
    ...
    'applicant_num_received','toudang_detail_url','quedang_num','admission_guide_desc','admission_guide_url']
        ...
        self.batch = u'zy_3_2_2017'  # 本科一批第二次网报
        self.create_dir()
    ...
    def parse(self, url):
        ...
        with open(os.path.join(self.storage, bname), 'w') as f:
            print >>f, r.text.encode('utf-8')
        return
        # 解析html
        soup = BeautifulSoup(r.text, "html5lib", from_encoding='gbk')
...
if __name__ == '__main__':
    ...
    a = {
        u'普通文科': 'http://www.nm.zsks.cn/zy_3_2_2017/3_A_3.html',
        u'普通理科': 'http://www.nm.zsks.cn/zy_3_2_2017/3_B_3.html',
        u'蒙授文科': 'http://www.nm.zsks.cn/zy_3_2_2017/3_C_3.html',
        u'蒙授理科': 'http://www.nm.zsks.cn/zy_3_2_2017/3_D_3.html'
    }
    '''
